...
console.log(firstWordUpperCase('hello world wassup!',dashesBetweenWords));
...
console.log(allWordsUpperCase(allWordsUpperCase('hello world wassup!',arrOfStringsToUpperCase),dashesBetweenWords));
