...
const book2 = {
    ...
    author: "Ghassan Kanafani",
    publishingYear: 1969,
    about: "mainly depicts Israel occupation over the Palestinian lands during the 1948 war in Haifa when Britain was in control of the land.",
    where: "Haifa",
};
const bookUtils = {
...
bookUtils.setPublisher(book1, "dar alketab", "haifa");
bookUtils.setPublisher(book2, "dar alketab", "haifa");
